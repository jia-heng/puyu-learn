...
class WinAtten(nn.Module):
    def __init__(self, ch, block_size=8, num_heads=4, bias=False):
        ...
        self.q_conv = nn.Conv2d(10, ch, kernel_size=1, bias=bias)
        self.k_conv = nn.Conv2d(10, ch, kernel_size=1, bias=bias)
...
class TemporalAttention(nn.Module):
    def __init__(self, ch, block_size=8, num_heads=4, checkpoint=True): # ch=32, checkpoint=False
